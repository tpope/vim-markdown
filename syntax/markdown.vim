...
exe 'syn region markdownItalic matchgroup=markdownItalicDelimiter start="\w\@<!_\S\@=" end="\S\@<=_\w\@!" keepend contains=markdownLineStart,@Spell' . s:concealends
...
exe 'syn region markdownBold matchgroup=markdownBoldDelimiter start="\w\@<!__\S\@=" end="\S\@<=__\w\@!" keepend contains=markdownLineStart,markdownItalic,@Spell' . s:concealends
...
exe 'syn region markdownBoldItalic matchgroup=markdownBoldItalicDelimiter start="\w\@<!___\S\@=" end="\S\@<=___\w\@!" keepend contains=markdownLineStart,@Spell' . s:concealends
